...
<br>
From the prediction, the $R^{2}$ of both train and test data rae more the 90%, which indicates the prediction is fairly in good aggreement with experiemnt Tc
<br>
<br>
